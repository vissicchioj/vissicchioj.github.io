...
const APP_NAME: string    = "brOS";   // Not just OS, a bro too
const APP_VERSION: string = "0.0101";   // 'cause binary is pretty cool
...
var _MemTable: HTMLTableElement;         // Initialized in Control.hostInit().
var _CpuTable: HTMLTableElement;         // Initialized in Control.hostInit().
var _PcbTable: HTMLTableElement;         // Initialized in Control.hostInit().
var _DiskTable: HTMLTableElement;         // Initialized in Control.hostInit().
