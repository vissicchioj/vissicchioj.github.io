module POM 
{
    ...
    {
        // we can have another array that holds previously used ones
        // then we cut put it back in the game list when there are no more left
        ...
        public compareGames(firstGame: string[], secondGame: string[], choice: boolean)
        {
        ...
        public setCurrentGames(gameDetails1: string[], gameDetails2: string[])
        {
        ...
        public getCurrentGame(gameNum: number): string[]
        {
            if (gameNum === 1)
            {
